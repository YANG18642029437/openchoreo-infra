...
require_literal "$tasks" 'retries: 60'
require_literal "$tasks" 'delay: 5'
require_literal "$tasks" 'k3s_etcd_ssd_local_readyz.rc == 0'
require_literal "$tasks" '--mountpoint'
require_literal "$tasks" 'k3s_etcd_ssd_fstab_findmnt'
require_literal "$tasks" 'k3s_etcd_ssd_data_path not in k3s_etcd_ssd_fstab_findmnt.stdout'
